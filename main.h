...
typedef enum
{
	PROGRAM_STATE_BROWSING,
	PROGRAM_STATE_AWAITING_JUMP_CHARACTER,
	PROGRAM_STATE_ENTER_SEARCH_FILTER_CASE_SENSITIVE,
	PROGRAM_STATE_ENTER_SEARCH_FILTER_CASE_INSENSITIVE,
} program_state;
